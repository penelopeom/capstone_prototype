...
main(['install','bs4'])
from pip._internal import main
main(['install','webdriver_manager'])
...
def contact_func(address):
    ...
    # driver = webdriver.Chrome("Chrome\Application\chrome.exe")
    ...
    src = driver.page_source
    contact = soup.find_all("html", string="contact")["href"]
    print(contact)

contact_func("12.150.236.18")
